...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__template_foodBox_tpl_html__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__template_foodBox_tpl_html___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__template_foodBox_tpl_html__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__template_foodTab_tpl_html__ = __webpack_require__(23);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__template_container_tpl_html__ = __webpack_require__(24);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__template_badge_tpl_html__ = __webpack_require__(25);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__template_deliveryType_tpl_html__ = __webpack_require__(26);
...
async function initBanchan() {
    ...
    const foodTabString = food.map(value => __WEBPACK_IMPORTED_MODULE_2__template_foodTab_tpl_html___default()({
    ...
    const containerString = food.map(value => __WEBPACK_IMPORTED_MODULE_3__template_container_tpl_html___default()({
        category_id: value.category_id
    })).join('');
    ...
    food.forEach((value, i) => {
        const foodBoxStrs = value.items.map(item =>
            __WEBPACK_IMPORTED_MODULE_1__template_foodBox_tpl_html___default()({
                image: item.image,
                alt: item.alt,
                title: item.title,
    ...
    food.forEach((value, i) => {
        value.items.forEach((item, j) => {
            const badges = __WEBPACK_IMPORTED_MODULE_4__template_badge_tpl_html___default()({
                badge: item.badge
            });
            foodBox[i * 3 + j].insertAdjacentHTML('beforeend', badges);
            const deliveryType = __WEBPACK_IMPORTED_MODULE_5__template_deliveryType_tpl_html___default()({
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__helpers__["a" /* $delegate */])('body', 'a', 'click', e => e.preventDefault());
}
