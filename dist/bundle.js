...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__template_badgeSide_tpl_html__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__template_badgeSide_tpl_html___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__template_badgeSide_tpl_html__);
...
class View {
    ...
    bindSlidesSidePrev(handler) {
        Object(__WEBPACK_IMPORTED_MODULE_6__helpers__["b" /* $on */])(this.slidesSidePrevEl, 'click', throttle(() => handler(10), 800));
    }

    bindSlidesSideNext(handler) {
        Object(__WEBPACK_IMPORTED_MODULE_6__helpers__["b" /* $on */])(this.slidesSideNextEl, 'click', throttle(() => handler(-10), 800));
    }

    bindSideSlides(handler) {
        Object(__WEBPACK_IMPORTED_MODULE_6__helpers__["b" /* $on */])(this.sideFoodBoxEl, 'transitionend', () => handler(true));
    }
    ...
    renderFoodContainer(food) {
        Object(__WEBPACK_IMPORTED_MODULE_6__helpers__["c" /* qs */])('.best_food_container').insertAdjacentHTML('afterbegin', food.map(value => __WEBPACK_IMPORTED_MODULE_2__template_container_tpl_html___default()({
            category_id: value.category_id
        })).join(''));
    }
    ...
    renderFoodBoxSide(food) {
        ...
        food.forEach((item, i) => {
            prdBox[i].insertAdjacentHTML('beforeend', __WEBPACK_IMPORTED_MODULE_4__template_badgeSide_tpl_html___default()({
                badge: item.badge
            }));
