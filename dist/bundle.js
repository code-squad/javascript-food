...
class View {
    ...
    bind(bindCmd, handler) {
        const bindCommands = {
            ...
            searches: () => {
                Object(__WEBPACK_IMPORTED_MODULE_0__helpers__["c" /* on */])(this.searchEl, 'click', () => handler());
            }
        };
