...
class View {
    ...
    renderFoodTab(food) {
        const foodTabString = food.map(value => __WEBPACK_IMPORTED_MODULE_1__template_foodTab_tpl_html___default()({
    ...
    renderFoodContainer(food) {
        const foodContainer = Object(__WEBPACK_IMPORTED_MODULE_5__helpers__["c" /* qs */])('.best_food_container');
        const containerString = food.map(value => __WEBPACK_IMPORTED_MODULE_2__template_container_tpl_html___default()({
            category_id: value.category_id
        })).join('');
    ...
    renderFoodList(food) {
        this.foodListEl = Object(__WEBPACK_IMPORTED_MODULE_5__helpers__["d" /* qsa */])('.best_food_box_list');
    ...
    renderFoodBox(food) {
        ...
        food.forEach((value, i) => {
            value.items.forEach((item, j) => {
                const badges = __WEBPACK_IMPORTED_MODULE_3__template_badge_tpl_html___default()({
                    badge: item.badge
                });
                foodBox[i * 3 + j].insertAdjacentHTML('beforeend', badges);
                const deliveryType = __WEBPACK_IMPORTED_MODULE_4__template_deliveryType_tpl_html___default()({
    ...
    renderFoodTabList(food, initNum) {
        const foodTabList = Object(__WEBPACK_IMPORTED_MODULE_5__helpers__["d" /* qsa */])('.best_food_tabs > li > a');
