...
class Controller {
    ...
    moveScroll(to) {
        ...
        const animateScroll = () => {
            ...
            let newY = Object(__WEBPACK_IMPORTED_MODULE_0__helpers__["b" /* easeInOutQuad */])(currentTime, start, change, duration);
            scrollTo(0, newY);
    ...
    bind(event, handler) {
        switch (event) {
            ...
            case 'slidesDots':
                ...
                break;
            case 'scroller':
                Object(__WEBPACK_IMPORTED_MODULE_5__helpers__["a" /* delegate */])('.page_up_down_list', '.page_up_down_list > li > a', 'click', (e) => handler(e.delegateTarget.dataset.direction));
                break;
            case 'foodTab':
