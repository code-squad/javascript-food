...
var Controller = function () {
    ...
    _createClass(Controller, [{
        ...
        value: async function checkLocalStorage(key) {
            ...
            var data = await (0, _helpers.request)(key);
            var value = {
                data: data,
                time: Date.now()
            };
