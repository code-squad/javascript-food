...
class Controller {
    ...
    async autoComplete(term, key) {
        if (!key || (key < 35 || key > 40) && key !== 13 && key !== 27) {
            ...
            if (!suggestions) {
                const response = await Object(__WEBPACK_IMPORTED_MODULE_0__helpers__["f" /* request */])(`http://crong.codesquad.kr:8080/ac/${term}`);
