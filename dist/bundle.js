...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__infiniteView__ = __webpack_require__(29);
...
class InfiniteView {
    constructor() {
        this.sideFoodBoxEl = Object(__WEBPACK_IMPORTED_MODULE_3__helpers__["d" /* qs */])('.side_food .infinite_food_box_list');
        this.sideSlidesPrevEl = Object(__WEBPACK_IMPORTED_MODULE_3__helpers__["d" /* qs */])('.side_food .slides_prev');
        this.sideSlidesNextEl = Object(__WEBPACK_IMPORTED_MODULE_3__helpers__["d" /* qs */])('.side_food .slides_next');

        this.mainFoodBoxEl = Object(__WEBPACK_IMPORTED_MODULE_3__helpers__["d" /* qs */])('.main_food .infinite_food_box_list');
        this.mainSlidesPrevEl = Object(__WEBPACK_IMPORTED_MODULE_3__helpers__["d" /* qs */])('.main_food .slides_prev');
        this.mainSlidesNextEl = Object(__WEBPACK_IMPORTED_MODULE_3__helpers__["d" /* qs */])('.main_food .slides_next');

        this.courseFoodBoxEl = Object(__WEBPACK_IMPORTED_MODULE_3__helpers__["d" /* qs */])('.course_food .infinite_food_box_list');
        this.courseSlidesPrevEl = Object(__WEBPACK_IMPORTED_MODULE_3__helpers__["d" /* qs */])('.course_food .slides_prev');
        this.courseSlidesNextEl = Object(__WEBPACK_IMPORTED_MODULE_3__helpers__["d" /* qs */])('.course_food .slides_next');
    ...
    bind(bindCmd, handler) {
        const bindCommands = {
            sideSlides: () => {
                Object(__WEBPACK_IMPORTED_MODULE_3__helpers__["c" /* on */])(this.sideFoodBoxEl, 'transitionend', () => handler(this.state.side));
            },
            sideSlidesPrev: () => {
                Object(__WEBPACK_IMPORTED_MODULE_3__helpers__["c" /* on */])(this.sideSlidesPrevEl, 'click', Object(__WEBPACK_IMPORTED_MODULE_3__helpers__["g" /* throttle */])(() => handler(this.state.side, 10), 600));
            },
            sideSlidesNext: () => {
                Object(__WEBPACK_IMPORTED_MODULE_3__helpers__["c" /* on */])(this.sideSlidesNextEl, 'click', Object(__WEBPACK_IMPORTED_MODULE_3__helpers__["g" /* throttle */])(() => handler(this.state.side, -10), 600));
            },
            mainSlides: () => {
                Object(__WEBPACK_IMPORTED_MODULE_3__helpers__["c" /* on */])(this.mainFoodBoxEl, 'transitionend', () => handler(this.state.main));
            },
            mainSlidesPrev: () => {
                Object(__WEBPACK_IMPORTED_MODULE_3__helpers__["c" /* on */])(this.mainSlidesPrevEl, 'click', Object(__WEBPACK_IMPORTED_MODULE_3__helpers__["g" /* throttle */])(() => handler(this.state.main, 10), 600));
            },
            mainSlidesNext: () => {
                Object(__WEBPACK_IMPORTED_MODULE_3__helpers__["c" /* on */])(this.mainSlidesNextEl, 'click', Object(__WEBPACK_IMPORTED_MODULE_3__helpers__["g" /* throttle */])(() => handler(this.state.main, -10), 600));
            },
            courseSlides: () => {
                Object(__WEBPACK_IMPORTED_MODULE_3__helpers__["c" /* on */])(this.courseFoodBoxEl, 'transitionend', () => handler(this.state.course));
            },
            courseSlidesPrev: () => {
                Object(__WEBPACK_IMPORTED_MODULE_3__helpers__["c" /* on */])(this.courseSlidesPrevEl, 'click', Object(__WEBPACK_IMPORTED_MODULE_3__helpers__["g" /* throttle */])(() => handler(this.state.course, 10), 600));
            },
            courseSlidesNext: () => {
                Object(__WEBPACK_IMPORTED_MODULE_3__helpers__["c" /* on */])(this.courseSlidesNextEl, 'click', Object(__WEBPACK_IMPORTED_MODULE_3__helpers__["g" /* throttle */])(() => handler(this.state.course, -10), 600));
            }
        };
    ...
    renderBanchan(target, food) {
        ...
        this.renderFoodBox(food, Object(__WEBPACK_IMPORTED_MODULE_3__helpers__["e" /* qsa */])(`.${target.name}_food .prd_box>a`));
        this.renderSlides(target.el, Object(__WEBPACK_IMPORTED_MODULE_3__helpers__["e" /* qsa */])(`.${target.name}_food .prd_box`));
